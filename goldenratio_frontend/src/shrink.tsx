...
const Shrink = () => {
  ...
  useEffect(() => {
    const fetchImage = async () => {
      try {
        ...
        setImageData(data.processedImage.shrinkImage);
        // console.log(data.processedImage.shrinkImage)
      } catch (err) {
        console.error(err);
      }
    };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-[#0d163e] to-[#00092d] text-white p-6 bg-fixed">
      <h1 className="text-2xl font-bold text-center mb-8">Shrink Image Results</h1>
